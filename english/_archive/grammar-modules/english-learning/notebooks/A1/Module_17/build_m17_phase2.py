...
def build_phase2_notebook():
    ...
    cells.append(
        create_cell(
            "markdown",
            """# Module 17: Past Simple - Irregular Verbs - Controlled Practice
...
print("✅ Setup complete! Let's practice Past Simple irregular verbs!")""",
            f"cell-{cell_counter}",
        )
    )
    cell_counter += 1
...
---""",
    ...
    cells.append(
        create_cell(
            "markdown",
            """## Exercise Set 7: There Irregular Verbs (10 exercises)
