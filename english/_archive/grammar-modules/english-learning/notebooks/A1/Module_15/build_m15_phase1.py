...
def build_phase1_notebook():
    ...
    cells.append(
        create_cell(
            "markdown",
            """# Module 15: Past Simple - Was/Were - Introduction
...
print("✅ Setup complete! Let's learn about WAS and WERE!")""",
            f"cell-{cell_counter}",
        )
    )
    cell_counter += 1
    ...
    cells.append(
        create_cell(
            "markdown",
            """## 1. Introduction to Past Simple with Was/Were ⏰
...
audio.create_conversation_audio([
    ...
    cells.append(
        create_cell(
            "markdown", """### Conversation 3: There Was/Were</cell>""", f"cell-{cell_counter}"
        )
    )
    cell_counter += 1
    ...
    cells.append(
        create_cell(
            "code",
            """# Conversation using there was/were
audio.create_conversation_audio([
