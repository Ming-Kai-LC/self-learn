...
# Create Module 09: Fibonacci Retracements & S/R Zones
notebook = {
    "cells": [
        {
            "cell_type": "markdown",
...
# Save
with open("09_fibonacci_support_resistance.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=1, ensure_ascii=False)

print("Module 09 created successfully!")
